...
exports.selectConsortiumChatStatusList = async function(req, res, next)
{
    var resStatus = 0;
    var resMsg = "";
    var httpStatus = 201;
    ...
    else
    {
        try
        {
            ...
            let consortiumChatStatusList = await ConsortiumChatStatusService.getConsortiumChatStatusesForSelect();

            resStatus = 1;
            if(consortiumChatStatusList != null)
            {
                totalRecords = consortiumChatStatusList.length;
                consortiumChatStatusData = consortiumChatStatusList;
            }
        }
        catch(e)
        {
    ...
    responseObj.results = consortiumChatStatusData;
