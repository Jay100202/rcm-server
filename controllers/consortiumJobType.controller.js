var ConsortiumJobTypeService = require('../services/consortiumJobType.service')
...
exports.selectConsortiumJobTypeList = async function(req, res, next)
{
    var resStatus = 0;
    var resMsg = "";
    var httpStatus = 201;
    ...
    else
    {
        try
        {
            ...
            let consortiumJobTypeList = await ConsortiumJobTypeService.getConsortiumJobTypesForSelect();

            resStatus = 1;
            if(consortiumJobTypeList != null)
            {
                totalRecords = consortiumJobTypeList.length;
                consortiumJobTypeData = consortiumJobTypeList;
            }
        }
        catch(e)
        {
    ...
    responseObj.results = consortiumJobTypeData;
