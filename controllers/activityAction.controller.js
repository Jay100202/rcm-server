...
exports.selectActivityActionList = async function(req, res, next)
{
    var resStatus = 0;
    var resMsg = "";
    var httpStatus = 201;
    ...
    else
    {
        try
        {
            ...
            let activityActionList = await ActivityActionService.getActivityActionsForSelect();

            resStatus = 1;
            if(activityActionList != null)
            {
                totalRecords = activityActionList.length;
                activityActionData = activityActionList;
            }
        }
        catch(e)
        {
    ...
    responseObj.results = activityActionData;
