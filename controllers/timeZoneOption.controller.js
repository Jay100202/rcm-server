...
exports.selectTimeZoneOptionList = async function(req, res, next)
{
    var resStatus = 0;
    var resMsg = "";
    var httpStatus = 201;
    ...
    else
    {
        try
        {
            ...
            let timeZoneOptionList = await TimeZoneOptionService.getTimeZoneOptionForSelect();

            resStatus = 1;
            if(timeZoneOptionList != null)
            {
                totalRecords = timeZoneOptionList.length;
                timeZoneOptionData = timeZoneOptionList;
            }
        }
        catch(e)
        {
    ...
    responseObj.results = timeZoneOptionData;
