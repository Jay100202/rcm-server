...
exports.selectConsortiumChatUserTypeList = async function(req, res, next)
{
    var resStatus = 0;
    var resMsg = "";
    var httpStatus = 201;
    ...
    let totalRecords = 0;
    let consortiumChatUserTypeData = [];
    ...
    else
    {
        try
        {
            ...
            let consortiumChatUserTypeList = await ConsortiumChatUserTypeService.getConsortiumChatUserTypesForSelect();

            resStatus = 1;
            if(consortiumChatUserTypeList != null)
            {
                totalRecords = consortiumChatUserTypeList.length;
                consortiumChatUserTypeData = consortiumChatUserTypeList;
            }
        }
        catch(e)
        {
    ...
    responseObj.results = consortiumChatUserTypeData;
