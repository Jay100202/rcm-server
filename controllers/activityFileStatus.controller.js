...
exports.selectActivityFileStatusList = async function(req, res, next)
{
    var resStatus = 0;
    var resMsg = "";
    var httpStatus = 201;
    ...
    else
    {
        try
        {
            ...
            let activityFileStatusList = await ActivityFileStatusService.getActivityFileStatusesForSelect();

            resStatus = 1;
            if(activityFileStatusList != null)
            {
                totalRecords = activityFileStatusList.length;
                activityFileStatusData = activityFileStatusList;
            }
        }
        catch(e)
        {
    ...
    responseObj.results = activityFileStatusData;
