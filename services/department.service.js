...
// Async function to get the Departments List
exports.getDepartments = async function(req)
{
    ...
    try 
    {
        ...
        departments = await Department.populate(departments, populateOptions);
...
exports.checkDepartmentNameForDuplication = async function(id, departmentName) {
    var options = {
        departmentName : new RegExp(`^${departmentName}$`, 'i'),
        isDeleted: 0
    };
...
exports.findDepartmentById = async function(req, departmentId){
     ...
     try {
        ...
        {
            var department = await Department.findOne(options).populate(populateOptions);
        }
        return department;
     } catch (e) {
         throw Error('Error while Fetching Department' + e)
