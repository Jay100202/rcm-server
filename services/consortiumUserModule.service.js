var ConsortiumUserModule = require('../models/consortiumUserModule.model');
...
exports.getModules = async function(skipVal, limit, search, sortBy, sortOrder, status){
    ...
    try {
        var modules = await ConsortiumUserModule.paginate(fetchOptions, paginationOptions);
        return modules;
    } catch (e) {
...
exports.saveModule = async function(module)
{
    ...
    if(module.id && module.id != "")
    {
        try
        {
            modModule = await ConsortiumUserModule.findById(module.id);
        }
        catch(e){
            throw Error("Error occured while Finding the ConsortiumUserModule")
        }
    }

    let isAdd = false;
    if(!modModule){
        modModule = new ConsortiumUserModule();
    ...
    try{
        ...
        throw Error("And Error occured while updating the ConsortiumUserModule "+ e);
    }
}
...
exports.getModulesForSelect = async function(page, limit, searchStr, onlyActiveStatus){
    ...
    try {
        var modules = await ConsortiumUserModule.paginate(fetchOptions, paginationOptions, null);
        return modules;
    } catch (e) {
        throw Error('Error while Paginating ConsortiumUserModule')
    }
}
...
exports.findModuleById = async function(moduleId){
    ...
    try {
       var module = await ConsortiumUserModule.findOne(options).populate(populateOptions);
       return module;
    } catch (e) {
...
exports.findModuleByName = async function(name){
    ...
    try {
       var module = await ConsortiumUserModule.findOne(options)
        return module;
    } catch (e) {
        throw Error('Error while Fetching ConsortiumUserModule ' + e)
    }
}
...
exports.getAllRemainingModules = async function(allocatedModuleIdArr) {
    ...
    try {
        var modules = await ConsortiumUserModule.find(fetchOptions).populate(populateOptions);
        return modules;
    } catch (e) {
        throw Error('Error while Fetching ConsortiumUserModule' + e)
    }
...
exports.getAllModules = async function() {
  ...
  try {
      var modules = await ConsortiumUserModule.find(fetchOptions);
      return modules;
  } catch (e) {
      throw Error('Error while Fetching ConsortiumUserModule' + e)
  }
...
exports.checkIfConsortiumUserModuleUsesModuleCategory = async function(id) {
    var options = {
        isDeleted: 0,
        moduleCategory: id
    };
